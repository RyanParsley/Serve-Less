...
function createGrid () {
	...
	var pageWidth = $('body').children('.container').width();   //If you don't set body width, uncomment this
	var containerPosition = $('body').children('.container').position();
	var pageLeft = $('body').children('.container').css('padding-left');	  //If you don't set body width, uncomment this
	$("p:last").text("left: " + pageLeft +".");
	$('#less-grid').css({ 
							width: pageWidth,
							position: "fixed",
							top: "0",
